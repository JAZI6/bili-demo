class Carousel {
    constructor(oTarget) {
        this.oUl = oTarget.getElementsByClassName('smryCttCrsl-imgList')[0];
    ...
    carSwitch() {
            ...
            this.aDotLi[this.nNow].className = 'smryCttCrsl-activeDot';

            $aLi.each(function () {
                $(this).css("display") == "block" && $(this).animate({"opacity": 0}, 'fast', () => {
